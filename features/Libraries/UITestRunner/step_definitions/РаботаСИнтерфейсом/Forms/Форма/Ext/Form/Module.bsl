...
Процедура ЯНажимаюНаКнопку(Парам01) Экспорт
	Если ЗначениеЗаполнено(Ванесса.СпецсимволЗаголовкаТекущегоСценария)
		И Лев(Парам01, 1) = Ванесса.СпецсимволЗаголовкаТекущегоСценария Тогда
		
		ВОткрытойФормеЯНажимаюНаКнопку(Сред(Парам01, 2), Истина);
	Иначе
		ВОткрытойФормеЯНажимаюНаКнопку(Парам01);
	КонецЕсли;
КонецПроцедуры
